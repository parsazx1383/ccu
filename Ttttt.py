...
DBName = "amyeyenn_SELF" # Database Name
api_channel = "SHAH_SELF"  # یا از تنظیمات بخوانید
DBUser = "amyeyenn_SELF" # Database User
DBPass = "Zxcvbnm1111" # Database Password
HelperDBName = "amyeyenn_HELP" # Helper Database Name
HelperDBUser = "amyeyenn_HELP" # Helper Database User
